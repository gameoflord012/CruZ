...
namespace CruZ.Framework.GameSystem.Render
{
    ...
    public class BloomFilter : IDisposable
    {
        ...
        public BloomFilter(GraphicsDevice graphicsDevice, SurfaceFormat renderTargetFormat = SurfaceFormat.Color)
        {
            ...
            _bloomEffect = EffectManager.Bloom;
        ...
        public void UpdateResolution(int width, int height)
        {
            ...
            _bloomRenderTarget2DMip0 = new RenderTarget2D(_graphicsDevice,
                width,
                height, false, _renderTargetFormat, DepthFormat.None, 0, RenderTargetUsage.PreserveContents);
